...
@Component({
  selector: 'app-button-icon-send-message',
  template: `
    <button type="submit" class="ml-2 px-2 rounded bg-[#b30000] text-white w-[60px] h-[60px]" 
      [ngClass]="class"
      [disabled]="disabled || isLoading"
      [attr.type]="type"
    >
      <svg *ngIf="!isLoading" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="90%" height="90%" viewBox="0 0 256 256" xml:space="preserve">
...
export class ButtonIconSendMessageComponent {
